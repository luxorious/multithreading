...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(l + " sum total");
        System.out.println("------------------------");
        ...
        if (validationThreadNumbers(availableThreads)){
    ...
    //check if any valid threads
    public static boolean validationThreadNumbers(int threadsQuantity) {
